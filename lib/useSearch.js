...
exports.useCoreSearch = exports.useSearchOne = exports.useSearchOneProps = exports.useSearch = exports.mergeParam = exports.callSearch = void 0;
...
var callSearch = function (se, search3, showResults3, searchError3, lc, nextPageToken) {
  var s = (0, reflect_1.clone)(se);
  var page = se.page;
  if (!page || page < 1) {
    page = 1;
  }
...
exports.callSearch = callSearch;
var appendListOfState = function (results, list, setState2) {
  var arr = (0, search_1.append)(list, results);
  setState2({ list: arr });
};
...
var useSearch = function (refForm, initialState, service, p2, p) {
  var baseProps = (0, exports.useCoreSearch)(refForm, initialState, service, p2, p);
  (0, react_1.useEffect)(function () {
    ...
    if (refForm) {
      ...
      (0, core_1.initForm)(refForm.current, registerEvents);
    }
    if (p && p.initialize) {
      ...
      try {
        var s = (0, search_1.mergeFilter)((0, route_1.buildFromUrl)(se), se, component.pageSizes);
        load(s, p2.auto);
      }
      catch (error) {
        searchError(error);
...
var useSearchOneProps = function (p) {
  return (0, exports.useSearch)(p.refForm, p.initialState, p.service, p, p);
};
exports.useSearchOneProps = useSearchOneProps;
var useSearchOne = function (p) {
  return (0, exports.useCoreSearch)(p.refForm, p.initialState, p.service, p, p);
};
exports.useSearchOne = useSearchOne;
var useCoreSearch = function (refForm, initialState, service, p1, p2) {
  var p = mergeParam(p2);
  var _a = (0, react_1.useState)(), running = _a[0], setRunning = _a[1];
  var _getModelName = function () {
    return (0, core_1.getName)('filter', p && p.name ? p.name : undefined);
  };
  var getModelName = (p && p.getModelName ? p.getModelName : _getModelName);
  var baseProps = (0, update_1.useUpdate)(initialState, getModelName, p1.getLocale, (0, core_1.getRemoveError)(p1));
  var state = baseProps.state, setState = baseProps.setState;
  var _b = (0, react_1.useState)(false), rerender = _b[0], setRerender = _b[1];
  (0, react_1.useEffect)(function () {
  ...
  var _c = (0, merge_1.useMergeState)(p), component = _c[0], setComponent = _c[1];
  var toggleFilter = function (event) {
    var x = !component.hideFilter;
    (0, core_1.handleToggle)(event.target, !x);
    setComponent({ hideFilter: x });
  };
  var _getFields = function () {
    var fields = component.fields, initFields = component.initFields;
    var fs = (0, search_1.getFieldsFromForm)(fields, initFields, refForm.current);
  ...
  var _getFilter = function (se) {
    ...
    var obj3 = (0, search_1.getModel)(state, n, se, fs, se.excluding);
    return obj3;
  };
  ...
  var _load = function (s, auto) {
    ...
    var obj2 = (0, search_1.initFilter)(s, com);
    setComponent(com);
    setFilter(obj2);
  ...
  var doSearch = function (se, isFirstLoad) {
    (0, core_1.removeFormError)(p1, refForm.current);
    var s = getFilter(se);
    if (isFirstLoad) {
      setState(state);
    }
    ...
    validateSearch(s, function () {
      ...
      if (p && !p.ignoreUrlParam) {
        (0, search_1.addParametersIntoUrl)(s, isFirstLoad);
      }
      var lc = p1.getLocale ? p1.getLocale() : state_1.enLocale;
      if (typeof service === 'function') {
        (0, exports.callSearch)(s, service, showResults, searchError, lc, se.nextPageToken);
      }
      else {
        (0, exports.callSearch)(s, service.search, showResults, searchError, lc, se.nextPageToken);
      }
    });
  };
  var _validateSearch = function (se, callback) {
    (0, search_1.validate)(se, callback, refForm.current, (p1.getLocale ? p1.getLocale() : undefined), (0, core_1.getValidateForm)(p1));
  };
  ...
  var sort = function (event) {
    ...
    if (event && event.target) {
      ...
      var s = (0, search_1.handleSort)(target, component.sortTarget, component.sortField, component.sortType);
      setComponent({
        sortField: s.field,
        sortType: s.type,
        sortTarget: target
  ...
  var resetAndSearch = function () {
    ...
    (0, search_1.removeSortStatus)(component.sortTarget);
    setComponent({
  ...
  var searchError = function (err) {
    ...
    (0, core_1.error)(err, p1.resource.value, p1.showError);
  ...
  var _showResults = function (s, sr, lc) {
    ...
    if (results && results.length > 0) {
      (0, search_1.formatResults)(results, component.pageIndex, component.pageSize, component.pageSize, p ? p.sequenceNo : undefined, p ? p.format : undefined, lc);
    }
    ...
    if (am) {
      ...
      (0, search_1.handleAppend)(component, sr.list, limit, sr.next);
      ...
      (0, search_1.showPaging)(component, sr.list, s.limit, sr.total);
      setList(results, setState);
      setComponent({ tmpPageIndex: s.page });
      if (s.limit) {
        var m1 = (0, search_1.buildMessage)(p1.resource, s.page, s.limit, sr.list, sr.total);
        p1.showMessage(m1);
      }
    }
    setRunning(false);
...
exports.useCoreSearch = useCoreSearch;
