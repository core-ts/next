...
var useCoreEdit = function (refForm, initialState, service, p1, p, props) {
  ...
  var _onSave = function (isBack) {
    ...
    if (flag.newMode) {
      ...
      var diffObj_1 = (0, reflect_1.makeDiff)((0, edit_1.initPropertyNullInModel)(flag.originalModel, metadata), obj, keys, version);
      ...
      service.load(id).then(function (obj) {
        ...
        if (data && data.status === 404) {
          ...
          if (data && (data.status === 401 || data.status === 403)) {
            (0, formutil_1.setReadOnly)(refForm.current);
          }
