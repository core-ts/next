...
var _getModelName = function (f2) {
  return (0, core_1.getModelName)(f2, m);
};
var useUpdate = function (initialState, getName, getLocale, removeErr) {
  ...
  var updatePhoneState = function (event) {
    ...
    var value = (0, core_1.removePhoneFormat)(target.value);
  ...
  var updateState = function (e, callback, lc) {
    ...
    var l = (0, state_1.localeOf)(lc, getLocale);
    (0, state_1.handleEvent)(e, removeErr);
    var objSet = (0, state_1.buildState)(e, state, ctrl, mn, l);
    if (objSet) {
      if (callback) {
  ...
  var updateFlatState = function (e, callback, lc) {
    var objSet = (0, state_1.buildFlatState)(e, state, lc);
    if (objSet) {
      if (callback) {
