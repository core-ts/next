...
exports.buildFlatState = exports.valueOfCheckbox = exports.buildState = exports.handleProps = exports.handleEvent = exports.localeOf = exports.enLocale = void 0;
...
function handleProps(e, props, ctrl, modelName, tloc, prepareData) {
  ...
  if (props.setGlobalState) {
    var res = (0, util_1.valueOf)(ctrl, tloc, e.type);
    if (res.mustChange) {
      ...
      if (form) {
        ...
        if (field.indexOf('.') < 0 && field.indexOf('[') < 0) {
          ...
          (0, reflect_1.setValue)(propsDataForm, field, ctrl.value);
    ...
    if (modelName && modelName !== '') {
      ...
      if (type && type.toLowerCase() === 'checkbox') {
        ...
        if (field.indexOf('.') < 0 && field.indexOf('[') < 0) {
          ...
          (0, reflect_1.setValue)(model, field, ctrl.value);
        }
        var objSet = {};
        objSet[modelName] = model;
        return objSet;
        ...
        try {
          ...
          (0, reflect_1.setValue)(model, field, ctrl.value && ctrl.value !== '' ? selectedDate.toISOString() : null);
          objSet[modelName] = model;
          return objSet;
        }
        catch (error) {
        ...
        try {
          var selectedDate = new Date(ctrl.value);
          (0, reflect_1.setValue)(model, field, selectedDate.getTime());
          objSet[modelName] = model;
          return objSet;
        }
        catch (error) {
        ...
        var data = (0, util_1.valueOf)(ctrl, tloc, e.type);
        if (data.mustChange) {
          if (field.indexOf('.') < 0 && field.indexOf('[') < 0) {
            model[field] = data.value;
          }
          else {
            (0, reflect_1.setValue)(model, field, data.value);
          }
          var objSet = {};
          objSet[modelName] = model;
          return objSet;
...
function buildFlatState(e, state, l) {
  ...
  if (type && type.toLowerCase() === 'checkbox') {
    ...
    var data = (0, util_1.valueOf)(ctrl, l, e.type);
    if (data.mustChange) {
