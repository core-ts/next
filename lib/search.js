...
exports.validate = exports.getFieldsFromForm = exports.getModel = exports.toggleSortStyle = exports.removeSortStatus = exports.sort = exports.handleSort = exports.handleSortEvent = exports.addParametersIntoUrl = exports.buildMessage = exports.getPageTotal = exports.formatResults = exports.formatResultsByComponent = exports.getFields = exports.showPaging = exports.handleAppend = exports.append = exports.optimizeFilter = exports.changePage = exports.changePageSize = exports.reset = exports.more = exports.initFilter = exports.isArray = exports.mergeFilter = exports.resources = void 0;
    ...
    if (src.hasOwnProperty(key) && src[key] !== null && src[key] !== undefined) {
      if (Array.isArray(dest[key]) && typeof src[key] === 'string' && src[key].length > 0) {
        ...
        if (arrayObjKeySrc && arrayObjKeySrc.length > 1) {
          dest[key] = __spreadArray([], arrayObjKeySrc, true);
        }
        else {
          dest[key] = [];
          ...
          if (typeof objValue === 'string' || typeof objValue === 'number') {
            if (key === limit) {
              if (objValue !== resources.limit) {
                if (url.indexOf('?') === -1) {
                  url += "?".concat(key, "=").concat(objValue);
                }
                else {
                  url += "&".concat(key, "=").concat(objValue);
                }
            ...
            if (objValue instanceof Date) {
              if (url.indexOf('?') === -1) {
                url += "?".concat(key, "=").concat(objValue.toISOString());
              }
              else {
                url += "&".concat(key, "=").concat(objValue.toISOString());
              }
              ...
              if (Array.isArray(objValue)) {
                if (objValue.length > 0) {
                  ...
                  if (url.indexOf('?') === -1) {
                    url += "?".concat(key, "=").concat(strs.join(','));
                  }
                  else {
                    url += "&".concat(key, "=").concat(strs.join(','));
                  }
                ...
                for (var _b = 0, keysLvl2_1 = keysLvl2; _b < keysLvl2_1.length; _b++) {
                  ...
                  if (url.indexOf('?') === -1) {
                    if (objValueLvl2 instanceof Date) {
                      url += "?".concat(key, ".").concat(key2, "=").concat(objValueLvl2.toISOString());
                    }
                    else {
                      url += "?".concat(key, ".").concat(key2, "=").concat(objValueLvl2);
                    }
                  }
                  else {
                    if (objValueLvl2 instanceof Date) {
